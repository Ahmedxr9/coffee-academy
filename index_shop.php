...
<head>
    ...
    <link rel="stylesheet" href="Coffee Site/style.css">
...
<body>
        ...
        <div class="menu-content">
            <div class="hot-coffees">
                <div class="hot-coffees-image">
                    <img src="coffee Site/img/hot-coffees.jpg" alt="">
                </div>
            ...
            <div class="cold-coffees">
                <div class="cold-coffees-image">
                    <img src="coffee Site/img/cold-coffees.jpg" alt="">
                </div>
            ...
            <div class="frappucino-coffees">
                <div class="frappucino-coffees-image">
                    <img src="coffee Site/img/frappuccino.jpg" alt="">
                </div>
    ...
    <div class="shop" id="shop">
        ...
        <div class="shop-box">
            <div class="item-1">
                <div class="card">
                    <div class="card-image">
                        <img src="coffee Site/img/caramel-macchiato.jpg">
                    </div>
                    <div class="card-body">
            ...
            <div class="item-2">
                <div class="card">
                    <div class="card-image">
                        <img src="coffee Site/img/flat-white.png">
                    </div>
                    <div class="card-body">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
            ...
            <div class="item-3">
                <div class="card">
                    <div class="card-image">
                        <img src="coffee Site/img/chocolate-frappuccino.png">
                    </div>
                    <div class="card-body">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
            ...
            <div class="item-4">
                <div class="card">
                    <div class="card-image">
                        <img src="coffee Site/img/frappe.jpg">
                    </div>
                    <div class="card-body">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
            ...
            <div class="item-5">
                <div class="card">
                    <div class="card-image">
                        <img src="coffee Site/img/caffe-mocha.png">
                    </div>
                    <div class="card-body">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
            ...
            <div class="item-6">
                <div class="card">
                    <div class="card-image">
                        <img src="coffee Site/img/vanilla-frappuccino.jpg">
                    </div>
                    <div class="card-body">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
            ...
            <div class="item-7">
                <div class="card">
                    <div class="card-image">
                        <img src="coffee Site/img/white-chocolate-mocha.jpg">
                    </div>
                    <div class="card-body">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
            ...
            <div class="item-8">
                <div class="card">
                    <div class="card-image">
                        <img src="coffee Site/img/ice-latte.jpg">
                    </div>
                    <div class="card-body">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
    ...
    <div class="contact" id="contact">
        <div class="contact-box">
            ...
            <img src="coffee Site/img/bg-image.jpeg">
            </div>
        </div>
        <div class="contact-box">
    ...
    <div class="footer">
        <div class="footer-box">
            ...
            <div class="copyright">
                <label>Copyright &copy;Ahmed 2024</label>
            </div>
            <div class="brand">
